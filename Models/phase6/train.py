...
MODEL_SAVE_PATH = "best_model_phase6_fpn.pth"
...
if __name__ == "__main__":
    ...
    # --- MODEL: FPN (The Scale Expert) ---
    print("🏗️ Building FPN (ResNeXt50)...")
    model = smp.FPN(
    ...
    REPORT_DIR = os.path.join(SCRIPT_DIR, "Final_Phase6_FPN_Report")
