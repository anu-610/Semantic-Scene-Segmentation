...
MODEL_SAVE_PATH = "best_model_phase5_unetplusplus.pth"
DEVICE = 'cuda' if torch.cuda.is_available() else 'cpu'

# ResNet34 is very memory efficient, so Batch 16 is perfectly safe
BATCH_SIZE = 16 
LR = 0.0001
EPOCHS = 20
...
# --- MODEL: U-Net++ with ResNet34 (Stable) ---
print("🏗️ Building U-Net++ (ResNet34)...")
...
# --- TRAINING LOOP ---
print("🚀 STARTING PHASE 5 TRAINING (Stable Mode)...")
best_loss = float('inf')
...
for epoch in range(EPOCHS):
    ...
    if avg_val_loss < best_loss:
        ...
        # Unwrap if using DataParallel
        state_dict = model.module.state_dict() if isinstance(model, torch.nn.DataParallel) else model.state_dict()
        torch.save(state_dict, MODEL_SAVE_PATH)
        print("✅ Saved Phase 5 Model!")

print("🎉 Training Complete.")


# ====================================================
#  AUTOMATED REPORTING MODULE (THE "CHECKLIST" GENERATOR)
# ====================================================
...
if __name__ == "__main__":
    ...
    REPORT_DIR = os.path.join(SCRIPT_DIR, "Final_Phase5_UnetPlusPlus_Report")
