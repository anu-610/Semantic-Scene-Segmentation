...
MODEL_PATH = model_utils.get_model_path(
    "best_model_phase4_segformer.pth", 
    "/kaggle/input/models/anurajktk/phase4/pytorch/default/1/best_model_phase4_segformer.pth"
)
...
# ==========================================
# 5. MODEL SETUP (SegFormer Transformer)
# ==========================================
print(f"⏳ Loading SegFormer (MiT-B2) from {MODEL_PATH}...")
...
# Transformers need specific divisible input sizes
transform = A.Compose([
    A.Resize(512, 512),
...
# 6. INFERENCE LOOP
# ==========================================
print("🚀 Generating Full Phase 4 Report...")
results = []
...
plt.xticks(rotation=45, ha='right'); plt.title(f'Phase 4 IoU (Mean: {avg_iou:.2f})'); plt.ylim(0, 1.0); plt.tight_layout()
...
plt.tight_layout(); plt.savefig(f"{OUTPUT_DIR}/confusion_matrix.png")
...
print(f"🏆 PHASE 4 COMPLETE! MEAN IoU: {avg_iou:.4f}")