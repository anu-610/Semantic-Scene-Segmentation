...
MODEL_SAVE_PATH = "best_model_phase4_segformer.pth" 
DEVICE = 'cuda' if torch.cuda.is_available() else 'cpu'

# --- HYPERPARAMETERS ---
BATCH_SIZE = 16  # T4x2 can handle 16 easily with mit_b2
LR = 0.00006     # Transformers like lower Learning Rates (6e-5)
EPOCHS = 20
...
if __name__ == "__main__":
    ...
    train_transform = A.Compose([
        ...
        # Medium Jitter for Transformers
    ...
    print("🏗️ Building SegFormer (MiT-B2)...")
    model = smp.DeepLabV3Plus(
        encoder_name="mit_b2",  # The Transformer Encoder
    ...
    # AdamW is REQUIRED for Transformers
    optimizer = torch.optim.AdamW(model.parameters(), lr=LR, weight_decay=1e-4)
    scaler = GradScaler() 

    # --- TRAINING LOOP ---
    print("🚀 STARTING PHASE 4 TRAINING (Transformer)...")
    best_loss = float('inf')
    ...
    REPORT_DIR = os.path.join(SCRIPT_DIR, "Final_Phase4_SegFormer_Report")
