...
TRAIN_ROOT_DIR = "/kaggle/input/datasets/devil610/krackhack/Offroad_Segmentation_Training_Dataset/train"
VAL_ROOT_DIR = "/kaggle/input/datasets/devil610/krackhack/Offroad_Segmentation_Training_Dataset/val"

MODEL_SAVE_PATH = "best_model_phase3_effb4.pth"
...
if __name__ == "__main__":
    ...
    print(f"🏗️ Building EfficientNet-B4...")
    ...
    # --- LOSS & OPTIMIZER ---
    # Note: smp.losses need to be initialized carefully. 
    # Using simple combination for Phase 3 based on your snippet.
    ...
    # --- TRAINING LOOP ---
    print(f"🚀 STARTING SAFE MODE TRAINING (Batch Size {BATCH_SIZE})...")
    best_loss = float('inf')
    ...
    REPORT_DIR = os.path.join(SCRIPT_DIR, "Final_Phase3_EffB4_Report")
